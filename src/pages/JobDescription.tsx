        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-2">
              <h1 className="text-2xl font-bold text-gray-900">一键生成职位描述</h1>
              <span className="text-lg text-blue-600">Job Description Generator</span>
            </div>
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white rounded-xl border shadow-sm p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-xs text-gray-500 mb-1">职位名称</p>
                    <Input
                      value={jobTitle}
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <p className="text-xs text-gray-500 mb-1">所属部门 / 团队</p>
                      <Input
                        value={department}
                  ...
                  <div>
                    <p className="text-xs text-gray-500 mb-1">汇报对象</p>
                    <Input
                      value={reportTo}
              ...
              <div className="bg-white rounded-xl border shadow-sm p-6 space-y-4">
                ...
                <div className="space-y-3">
                  <div>
                    <p className="text-xs text-gray-500 mb-1">主要工作职责</p>
                    <Textarea
                  ...
                  <div>
                    <p className="text-xs text-gray-500 mb-1">任职要求</p>
                    <Textarea
                      value={requirements}
                  ...
                  <div>
                    <p className="text-xs text-gray-500 mb-1">理想候选人画像 / 加分项</p>
                    <Textarea
                      value={idealProfile}
              ...
              <div className="bg-white rounded-xl border shadow-sm overflow-hidden">
                <div className="flex items-center justify-between px-4 py-3 border-b bg-gray-50">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">候选人视角预览</span>
